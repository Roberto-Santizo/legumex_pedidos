...
export abstract class ContainersDatasource {
    ...
    abstract setDeliverySchedule(containerId: number, deliveryDate: string, deliveryTime: string): Promise<ContainerDetail>;
}
