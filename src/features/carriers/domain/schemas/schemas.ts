...
export const CarrierSchema = z.object({
    ...
    // Backend returns dc as a joined object {id, name, code} or as flat fields, or absent
    dc: z.object({ id: z.number(), name: z.string(), code: z.string().optional() }).nullable().optional(),
